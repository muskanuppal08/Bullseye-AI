...
export default function Home() {
  ...
  const handleDownloadMemo = () => {
    ...
    const content = `# Investment Research Memo: ${report.name} (${report.ticker})
...
- P/E Ratio: ${report.metrics.pe} (Sector Avg: 24.5x)
- PEG Ratio: ${report.metrics.peg}
- Profit Margin: ${report.metrics.margin}%
- Debt-to-Equity: ${report.metrics.debtToEquity}
- Revenue (TTM): ${report.metrics.revenue}
- Market Capitalization: ${report.metrics.marketCap}
...
## Deep-Dive Specialist Reports

### Financial Analysis Brief
${report.details.financials}

### Sentiment & Market Vibe Report
${report.details.sentiment}

### Competitor & Industry Benchmark
${report.details.competitors}

### Risk & Regulatory Assessment
${report.details.risks}

---
*Generated by BullseyeAI Investment Research Agent*
`;
    const blob = new Blob([content], { type: "text/markdown" });
    const url = URL.createObjectURL(blob);
    const link = document.createElement("a");
    link.href = url;
    link.download = `${report.ticker}_investment_memo.md`;
    link.click();
                    ...
                    <div className="flex-1 space-y-4 w-full">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full gap-4">
                        ...
                        <button
                          ...
                          className="px-4 py-2 rounded-xl bg-brand-purple/20 hover:bg-brand-purple/40 text-brand-pink border border-brand-purple/35 text-xs font-semibold flex items-center gap-2 transition-all active:scale-95 cursor-pointer shadow-lg hover:shadow-brand-purple/10"
                        >
